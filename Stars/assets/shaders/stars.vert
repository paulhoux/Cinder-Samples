...
const float MAG_LOWER_BOUND = 13.0;	// if a star's apparent magnitude is higher than this, it will be rendered at 0% brightness (black) - a value of 11 is more or less realistic
...
void main() { 
	...
	vColor = ciColor * pow(brightness, 1.5);
